...
const Gallery: React.FC<GalleryProps> = ({ data }) => {
  ...
  return (
    <section className="flex flex-col items-center px-4 sm:px-8 lg:px-12 lg:px-[136px] pb-[10px] pt-[36px] max-w-[1444px] mx-auto mb-[40px]" aria-labelledby="latest-updates-heading">
      <h2 
