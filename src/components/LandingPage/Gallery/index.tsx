...
const Gallery: React.FC<GalleryProps> = ({ data }) => {
  ...
  return (
    <section className="flex flex-col items-stretch items-center px-20 py-14 pt-[36px] max-md:px-5 max-w-[1444px] mx-auto" aria-labelledby="latest-updates-heading">
      <h2 
