...
export const HeroHeader: React.FC<HeroHeaderProps> = ({ title, subtitle }) => {
  return (
    <header className="flex w-full flex-col mb-5">
      <h1 className="text-black [font-family:Inter] text-[45px] font-extrabold leading-[45px] tracking-[0.045px] w-[500px] max-md:w-full max-md:text-[40px] max-md:leading-[39px]">
        {title}
      </h1>
