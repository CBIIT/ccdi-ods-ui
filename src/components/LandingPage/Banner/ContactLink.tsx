...
export const ContactLink: React.FC<ContactLinkProps> = ({ text, href }) => {
  return (
    <a 
      href={href}
      className="bg-[#FFFFFF] flex h-[41px] py-[12px] px-[30px] justify-center items-center gap-[40px_60px] text-sm font-bold uppercase tracking-[0.7px] leading-[36px] cursor-pointer w-auto"
    >
